...
new explorer.window()
  .title('Explorador Web') //set the title
  ...
  .callback(function() {
    ...
    function changeUrl(url) {
      ...
      win.title('Explorador Web - ' + url)
    };

    //Create the starting HTML
    bod.html('<button class="b1"><-</button><button class="b2">-></button><input class="i1"></input><button class="b3">Ir</button><iframe class="if1"></iframe>');
