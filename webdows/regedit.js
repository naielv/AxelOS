...
.callback(function() {
	...
	var bar = [
		{
			...
			context: [
				{
					...
					callback: function() {
						...
						.callback(function() {
							var imp = this;
							imp.body.html('<textarea style="resize:none;padding:0px;border:none;width:100%;height:120px"></textarea><br><button style="float:right;margin-right:10px;">Guardar Cambios</button>');
			...
			context: [
				{
					title: 'Sobre Editor de Registro...',
	...
	<div id="RSideBar"></div>
	<div id="LSide">
		<div><b><span>Nombre</span><span>Tipo</span><span>Valor</span></b></div>
	</div>
	`);
